...
var _AndroidDialogPickerNativeComponent = _interopRequireDefault(
  require("./AndroidDialogPickerNativeComponent")
);

var _AndroidDropdownPickerNativeComponent = _interopRequireDefault(
  require("./AndroidDropdownPickerNativeComponent")
);
...
function PickerAndroid(props, ref) {
  ...
  React.useImperativeHandle(ref, () => {
    const viewManagerConfig = _reactNative.UIManager.getViewManagerConfig(
    ...
    return {
      blur: () => {
        ...
        _reactNative.UIManager.dispatchViewManagerCommand(
          (0, _reactNative.findNodeHandle)(pickerRef.current),
    ...
    const items = React.Children.toArray(props.children).map((child, index) => {
      ...
      return {
        ...
        style: {
          ...style,
          color: style.color
            ? (0, _reactNative.processColor)(style.color)
            : null,
          backgroundColor: style.backgroundColor
            ? (0, _reactNative.processColor)(style.backgroundColor)
            : null,
        },
      };
    });
  ...
  const Picker =
    props.mode === MODE_DROPDOWN
      ? _AndroidDropdownPickerNativeComponent.default
      : _AndroidDialogPickerNativeComponent.default;
  const rootProps = {
    ...
    dropdownIconRippleColor: (0, _reactNative.processColor)(
      props.dropdownIconRippleColor
    ),
    testID: props.testID,

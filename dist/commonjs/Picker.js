...
class Picker extends React.Component {
  constructor(...args) {
    ...
    _defineProperty(this, "blur", () => {
      ...
      (_this$pickerRef$curre = this.pickerRef.current) === null ||
      _this$pickerRef$curre === void 0
        ? void 0
        : _this$pickerRef$curre.blur();
    });

    _defineProperty(this, "focus", () => {
      var _this$pickerRef$curre2;

      (_this$pickerRef$curre2 = this.pickerRef.current) === null ||
      _this$pickerRef$curre2 === void 0
        ? void 0
        : _this$pickerRef$curre2.focus();
    });
  }

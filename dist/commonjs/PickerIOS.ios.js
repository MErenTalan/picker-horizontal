...
var _RNCPickerNativeComponent = _interopRequireDefault(
  require("./RNCPickerNativeComponent")
);
...
class PickerIOS extends React.Component {
  ...
  render() {
    ...
    let numberOfLines = Math.round(
      (_this$props$numberOfL = this.props.numberOfLines) !== null &&
        _this$props$numberOfL !== void 0
        ? _this$props$numberOfL
        : 1
    );
